...
import br.com.carteira.cliente.domain.model.dto.CustomerSimpleDTO;
...
public class CustomerController {
	...
	@GetMapping("/all")
	public ResponseEntity<CustomerSimpleDTO[]> getAll() throws RequestBodyInvalidException {
		return ReponseUtil.getResponse(customerService.getAll(), CustomerSimpleDTO[].class);
	}
